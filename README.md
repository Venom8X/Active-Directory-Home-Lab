...
1. Click on the **Adapter 2** tab and configure the following settings:
   - **Enable Network Adapter**: Checked.
   - **Attached to**: Internal Network.
   - **Name**: `intnet` (or a name of your choice).
   - Leave all other settings as default.
...
1. Click **OK** to save the changes and close the settings window.

---

#### Explanation of Network Adapters
- **Adapter 1 (NAT):**
  - Provides the VM with internet access by using the host system's internet connection.
  - Useful for downloading updates or software during the setup process.
- **Adapter 2 (Internal Network):**
  - Creates a private network that connects the Windows Server VM to other VMs in your lab.
  - Used for domain-related communication, such as between the Domain Controller and client machines.
