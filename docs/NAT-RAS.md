...
## Table of Contents
- [Configuring NAT and Remote Access Service (RAS)](#select-role-services)

## Step 1: Select Role Services (refer to [Installing Active Directory Domain Services (AD DS)](/docs/usingAD.md#step-1-open-server-manager-and-select-add-roles-and-features) for adding roles and features)
